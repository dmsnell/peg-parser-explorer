...
var _user$project$GrammarExplorer$labelStyle = {
	ctor: '::',
...
var _user$project$GrammarExplorer$outputStyle = {
	ctor: '::',
...
var _user$project$GrammarExplorer$codeStyle = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'fira-code, consolas, fixed-width'},
	_1: {
		ctor: '::',
...
var _user$project$GrammarExplorer$grammarStyle = _user$project$GrammarExplorer$codeStyle;
var _user$project$GrammarExplorer$documentStyle = _user$project$GrammarExplorer$codeStyle;
var _user$project$GrammarExplorer$parsedStyle = _user$project$GrammarExplorer$codeStyle;
var _user$project$GrammarExplorer$tracerStyle = _user$project$GrammarExplorer$codeStyle;
var _user$project$GrammarExplorer$toolStyle = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'flex-basis', _1: 'fill'},
				_1: {
					ctor: '::',
...
var _user$project$GrammarExplorer$loaderStyle = {
	ctor: '::',
...
var _user$project$GrammarExplorer$appStyle = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'width', _1: '100%'},
	_1: {
		ctor: '::',
...
var _user$project$GrammarExplorer$cleanTrace = function (trace) {
	return A3(
...
var _user$project$GrammarExplorer$parse = _elm_lang$core$Native_Platform.outgoingPort(
	'parse',
	function (v) {
		return {grammar: v.grammar, document: v.document, shouldTrace: v.shouldTrace};
	});
var _user$project$GrammarExplorer$init = function (flags) {
	var model = {document: '>>>><<>><<<>>', grammar: _user$project$GrammarExplorer$initialGrammar, grammarUrl: 'https://raw.githubusercontent.com/WordPress/gutenberg/master/packages/block-serialization-spec-parser/grammar.pegjs', parsed: '', trace: '', shouldTrace: false};
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _user$project$GrammarExplorer$parse(
			{grammar: model.grammar, document: model.document, shouldTrace: model.shouldTrace})
	};
};
var _user$project$GrammarExplorer$parsed = _elm_lang$core$Native_Platform.incomingPort(
	'parsed',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (parsed) {
			return A2(
				...
				A2(_elm_lang$core$Json_Decode$field, 'trace', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'parsed', _elm_lang$core$Json_Decode$string)));
var _user$project$GrammarExplorer$Flags = {};
var _user$project$GrammarExplorer$Model = F6(
	function (a, b, c, d, e, f) {
		return {document: a, grammar: b, grammarUrl: c, parsed: d, trace: e, shouldTrace: f};
	});
var _user$project$GrammarExplorer$ParseResult = F2(
	function (a, b) {
		return {parsed: a, trace: b};
	});
var _user$project$GrammarExplorer$UpdateParse = function (a) {
	return {ctor: 'UpdateParse', _0: a};
};
var _user$project$GrammarExplorer$subscriptions = function (model) {
	return _user$project$GrammarExplorer$parsed(_user$project$GrammarExplorer$UpdateParse);
};
var _user$project$GrammarExplorer$UpdateDocument = function (a) {
	return {ctor: 'UpdateDocument', _0: a};
};
var _user$project$GrammarExplorer$UpdateGrammarUrl = function (a) {
	return {ctor: 'UpdateGrammarUrl', _0: a};
};
var _user$project$GrammarExplorer$UpdateGrammar = function (a) {
	return {ctor: 'UpdateGrammar', _0: a};
};
var _user$project$GrammarExplorer$ToggleTracing = {ctor: 'ToggleTracing'};
var _user$project$GrammarExplorer$LoadGrammar = function (a) {
	return {ctor: 'LoadGrammar', _0: a};
};
var _user$project$GrammarExplorer$fetchGrammar = function (url) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$GrammarExplorer$LoadGrammar,
		_elm_lang$http$Http$getString(url));
};
var _user$project$GrammarExplorer$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var parseIt = function (_p1) {
				var _p2 = _p1;
				return _user$project$GrammarExplorer$parse(
					{grammar: _p2.grammar, document: _p2.document, shouldTrace: model.shouldTrace});
			};
			var _p3 = msg;
			switch (_p3.ctor) {
				case 'FetchGrammar':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{document: _user$project$GrammarExplorer$initialDocument}),
						_1: _user$project$GrammarExplorer$fetchGrammar(model.grammarUrl)
					};
				case 'LoadGrammar':
					if (_p3._0.ctor === 'Ok') {
						var _v2 = _user$project$GrammarExplorer$UpdateGrammar(_p3._0._0),
							_v3 = model;
						msg = _v2;
						model = _v3;
						continue update;
				...
				default:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								parsed: _p3._0.parsed,
								trace: _user$project$GrammarExplorer$cleanTrace(_p3._0.trace)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
...
var _user$project$GrammarExplorer$FetchGrammar = {ctor: 'FetchGrammar'};
var _user$project$GrammarExplorer$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$appStyle),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$loaderStyle),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$labelStyle),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Grammar to fetch'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$inputStyle),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$type_('text'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$GrammarExplorer$UpdateGrammarUrl),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.grammarUrl),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$GrammarExplorer$FetchGrammar),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Toggle tracing'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$GrammarExplorer$ToggleTracing),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												model.shouldTrace ? 'Disable' : 'Enable'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(' (can be very slow for large documents and grammars) '),
										_1: {ctor: '[]'}
									}
								}
							}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$toolStyle),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$grammarStyle),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$GrammarExplorer$UpdateGrammar),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.grammar),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$documentStyle),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$GrammarExplorer$UpdateDocument),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.document),
											_1: {ctor: '[]'}
										}
									}
								},
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$outputStyle),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$parsedStyle),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.parsed),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$style(_user$project$GrammarExplorer$tracerStyle),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(model.trace),
														_1: {ctor: '[]'}
													}
												},
												{ctor: '[]'}),
...
var _user$project$GrammarExplorer$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$GrammarExplorer$init, subscriptions: _user$project$GrammarExplorer$subscriptions, update: _user$project$GrammarExplorer$update, view: _user$project$GrammarExplorer$view})(
	_elm_lang$core$Json_Decode$succeed(
		{}));

var Elm = {};
Elm['GrammarExplorer'] = Elm['GrammarExplorer'] || {};
if (typeof _user$project$GrammarExplorer$main !== 'undefined') {
    _user$project$GrammarExplorer$main(Elm['GrammarExplorer'], 'GrammarExplorer', undefined);
}
